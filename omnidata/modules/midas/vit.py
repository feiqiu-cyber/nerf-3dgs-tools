...
def _make_pretrained_vitb_rn50_384(
    ...
    model = timm.create_model("vit_base_resnet50_384", checkpoint_path='/cfs/wangboyuan/workspace/gaussian_surfels/submodules/omnidata/pretrained_models/pytorch_model.bin')
